"use strict";(self.webpackChunklandingpage_new=self.webpackChunklandingpage_new||[]).push([[583],{18:(e,C,t)=>{t.r(C),t.d(C,{default:()=>Qe});var i=t(781),a=t(6540);function n(e,C){return 0===C?0:(e%C+C)%C}var r=t(3540);const s=r.Ay.div`
  display: inline-flex;
  position: relative;
  width: 7em;
`,o=(r.Ay.div`
...
`;function W(){return(0,h.jsxs)(v,{children:[(0,h.jsxs)(B,{$flexDirection:"column",children:[(0,h.jsx)("p",{children:" Available on macOS. Coming soon on all other platforms."}),(0,h.jsx)(g,{href:"https://github.com/snip-app/client/releases/latest/download/Snip.dmg",children:(0,h.jsx)(f,{})})]}),(0,h.jsxs)(S,{$flexDirection:"column",children:[(0,h.jsx)("p",{children:" Available on iOS. Coming soon on all other platforms."}),(0,h.jsx)(g,{href:"https://apps.apple.com/ch/app/snip-notes-todos-reminders/id1584692945",children:(0,h.jsx)(f,{})})]})]})}const k=r.Ay.div`
...
`,V=r.Ay.div`
  ...
  background-color: black;
  transform: translateX(100%);
`;function I(e){return(0,h.jsx)(k,{className:e.className,children:(0,h.jsxs)(z,{children:[(0,h.jsxs)(M,{children:[e.children,(0,h.jsx)(Z,{}),(0,h.jsx)(F,{})]}),(0,h.jsx)(Y,{}),(0,h.jsx)(Q,{}),(0,h.jsx)(L,{}),(0,h.jsx)(V,{})]})})}const X=(0,r.Ay)(w)`
...
`,T=["Lightweight","Free Of Charge","Simple","Offline-First","Powerful","Modular","Private","Cross-Platform","Responsive"];function R(){return(0,h.jsxs)(a.Fragment,{children:[(0,h.jsxs)(X,{children:[(0,h.jsxs)(O,{children:[(0,h.jsxs)("h1",{children:["Note Taking Can Be \xa0",(0,h.jsx)("em",{children:(0,h.jsx)(m,{words:T,children:(0,h.jsxs)(a.Fragment,{children:[(0,h.jsx)(N,{variation:1}),(0,h.jsx)(H,{})]})})})]}),(0,h.jsxs)("h2",{children:["Snip Is Your Everyday \xa0",(0,h.jsx)("em",{children:"Productivity"}),"\xa0 Companion."]})]}),(0,h.jsxs)(D,{children:[(0,h.jsx)(E,{children:(0,h.jsx)("img",{src:t(5090).A})}),(0,h.jsx)(U,{children:(0,h.jsx)("img",{src:t(1238).A})})]})]}),(0,h.jsx)(W,{})]})}const J=(0,r.Ay)(w)`
  display: none;
...
`;function ee(){return(0,h.jsxs)(J,{children:[(0,h.jsx)(q,{}),(0,h.jsx)(K,{}),(0,h.jsx)(G,{}),(0,h.jsxs)(A,{children:[(0,h.jsxs)(_,{children:[(0,h.jsx)("h1",{children:"Dashboards"}),(0,h.jsx)("p",{children:"Pin notes to the navigation bar and use references to create dashboards."})]}),(0,h.jsx)($,{children:(0,h.jsx)("img",{src:t(1762).A})})]})]})}const Ce=(0,r.Ay)(w)`
  min-height: 40em;
...
`,le=r.AH`
  margin: 1em;
`;const he=r.Ay.div`
  ${e=>function(e){switch(e){case"on-the-right":return oe;case"on-the-left":return ce;case"at-the-bottom":return de;case"centered":return le}}(e.$position)}
  filter: drop-shadow(0px 5px 6px rgba(var(--box-shadow-base-color), 0.75));
`;function me(e){return(0,h.jsx)(se,{$width:e.width,className:e.className,children:(0,h.jsx)(he,{$position:e.position,children:e.children})})}const xe=(0,r.Ay)(w)`
  padding-top: 7em;
  padding-bottom: 10em;
  min-height: 100vh;
...
`,ve=(0,r.Ay)(be)`
  ...
  transform: translateX(-5em) translateY(6.5em) rotateZ(2deg);
  height: 12em;
`;function ye(){return(0,h.jsxs)(xe,{children:[(0,h.jsx)(je,{}),(0,h.jsx)(ue,{}),(0,h.jsx)(ve,{}),(0,h.jsx)("h1",{children:"Find And Organize"}),(0,h.jsxs)(pe,{children:[(0,h.jsxs)(fe,{children:[(0,h.jsx)("h2",{children:(0,h.jsx)(j,{children:(0,h.jsx)(re,{})})}),(0,h.jsx)("h2",{children:"Search"}),(0,h.jsx)("p",{children:"Snip offers fast and efficient search functionality, delivering well-formatted results that provide clear and concise previews of the content."})]}),(0,h.jsx)(we,{position:"at-the-bottom",children:(0,h.jsx)(b,{children:(0,h.jsx)("img",{src:t(3696).A})})})]}),(0,h.jsx)(Ae,{}),(0,h.jsxs)(ge,{children:[(0,h.jsxs)(fe,{children:[(0,h.jsx)("h2",{children:(0,h.jsx)(j,{children:(0,h.jsx)(ne,{})})}),(0,h.jsx)("h2",{children:"Icons"}),(0,h.jsx)("p",{children:"Snip includes a collection of icons that enhance the structure of your notes, adding both clarity and visual appeal."})]}),(0,h.jsx)(we,{position:"on-the-right",children:(0,h.jsx)(b,{children:(0,h.jsx)("img",{src:t(1315).A})})})]})]})}const Be=(0,r.Ay)(w)`
...
`,ke=r.Ay.div`
  ...
  max-width: calc(100% - 2em);
`;function ze(){return(0,h.jsxs)(Be,{children:[(0,h.jsxs)(A,{$flexDirection:"column",children:[(0,h.jsx)("h2",{children:"Spaced Repetition With Flashcards"}),(0,h.jsxs)(Se,{children:[(0,h.jsx)("p",{children:'Snip is all about taking notes. In Snip, a "Note" is in fact called a "Snippet" (hence the name "Snip"). A Snippet is a piece of data that can be represented in a graphical user interface.'}),(0,h.jsx)("p",{children:"When taking notes, you will be using the Rich Text Snippet. It represents some text on which you can apply formatting such as titles, sub-titles, quotes, code blocks, bold and italic text, etc."}),(0,h.jsx)("p",{children:"In the following section, you will learn about another Snippet type, the Flashcard Snippet, which is very similar to a Rich Text Snippet, but comes with additional functionality, allowing you to use Snip as a spaced repetition app."})]})]}),(0,h.jsxs)(A,{$flexDirection:"column",children:[(0,h.jsxs)(We,{children:[(0,h.jsxs)(ke,{children:[(0,h.jsx)("h3",{children:"Flashcard Snippet"}),(0,h.jsx)("p",{children:"Conceptually, a flashcard snippet is identical to a real world flash card: It has two sides, where one side is a question or prompt and the other side is an answer or information. For example, this can be used for learning a new language."})]}),(0,h.jsx)(me,{width:"30em",position:"at-the-bottom",children:(0,h.jsx)(b,{children:(0,h.jsx)("img",{src:t(2687).A})})})]}),(0,h.jsxs)(We,{children:[(0,h.jsxs)(ke,{children:[(0,h.jsx)("h3",{children:"Dashboard"}),(0,h.jsx)("p",{children:"The Dashboard gives an overview of all the flashcards in this folder. It shows your learning progress over time and lists all flashcards ordered by relevance. The relevance of a card is calculated through a scoring algorithm."})]}),(0,h.jsx)(me,{width:"35em",position:"on-the-right",children:(0,h.jsx)(b,{children:(0,h.jsx)("img",{src:t(8098).A})})})]}),(0,h.jsxs)(We,{children:[(0,h.jsxs)(ke,{children:[(0,h.jsx)("h3",{children:"Session Wizard"}),(0,h.jsx)("p",{children:"Flashcards can be practiced in an interactive mode. When stepping through the flashcards, a rating can be provided, which will re-prioritize the flashcards in the next session."})]}),(0,h.jsx)(me,{width:"25em",position:"at-the-bottom",children:(0,h.jsx)(b,{children:(0,h.jsx)("img",{src:t(2865).A})})})]})]})]})}const Me=(0,r.Ay)(w)`
  display: none;
  background-color: var(--accent-color-1);
  color: var(--accent-contrast-color-1);
  min-height: 100vh;
