"use strict";(self.webpackChunklandingpage_new=self.webpackChunklandingpage_new||[]).push([[583],{9467:(e,C,t)=>{t.r(C),t.d(C,{default:()=>Ze});var i=t(781),a=t(6540);function r(e,C){return 0===C?0:(e%C+C)%C}var s=t(3540);const n=s.Ay.div`
  display: inline-flex;
  position: relative;
  width: 7em;
`,o=(s.Ay.div`
...
`;var h=t(4848);function m(e){const[C,t]=(0,a.useReducer)((C=>r(C+1,e.words.length)),-1),[i,s]=[e.words.at(C),e.words.at(r(C+1,e.words.length))];(0,a.useEffect)((()=>{const e=setInterval((()=>{t()}),3e3);return()=>{clearInterval(e)}}),[]);const o=(0,h.jsxs)(a.Fragment,{children:[(0,h.jsx)("div",{children:"\xa0"}),e.children]});return-1===C?(0,h.jsxs)(n,{children:[o,(0,h.jsx)(d,{children:e.words.at(0)})]}):(0,h.jsxs)(n,{children:[o,(0,h.jsx)(l,{$animation:"out",children:i},i),(0,h.jsx)(l,{$animation:"in",children:s},s)]})}const x=s.Ay.section`
  position: relative;
  overflow: hidden;
...
`;function z(){return(0,h.jsxs)(j,{children:[(0,h.jsx)(p,{children:"Available on all Platforms."}),(0,h.jsxs)(v,{children:[(0,h.jsx)(y,{href:"https://github.com/snip-app/client/releases/latest/download/Snip.dmg",children:(0,h.jsx)(B,{children:(0,h.jsx)(A,{})})}),(0,h.jsx)(y,{children:(0,h.jsx)(B,{children:(0,h.jsx)(b,{})})}),(0,h.jsx)(y,{href:"https://github.com/snip-app/client/releases/latest/download/Snip.deb",children:(0,h.jsx)(B,{children:(0,h.jsx)(u,{})})})]})]})}const M=s.Ay.div`
...
`,Y=s.Ay.div`
  ...
  background-color: black;
  transform: translateX(100%);
`;function L(e){return(0,h.jsx)(M,{className:e.className,children:(0,h.jsxs)(S,{children:[(0,h.jsxs)(W,{children:[e.children,(0,h.jsx)(k,{}),(0,h.jsx)(Z,{})]}),(0,h.jsx)(F,{}),(0,h.jsx)(V,{}),(0,h.jsx)(Q,{}),(0,h.jsx)(Y,{})]})})}const I=(0,s.Ay)(x)`
...
`,T=["Lightweight","Free Of Charge","Simple","Offline-First","Powerful","Modular","Private","Cross-Platform","Responsive"];function U(){return(0,h.jsxs)(a.Fragment,{children:[(0,h.jsxs)(I,{children:[(0,h.jsxs)(X,{children:[(0,h.jsxs)("h1",{children:["Note Taking Can Be \xa0",(0,h.jsx)("em",{children:(0,h.jsx)(m,{words:T,children:(0,h.jsxs)(a.Fragment,{children:[(0,h.jsx)(H,{variation:1}),(0,h.jsx)(N,{})]})})})]}),(0,h.jsxs)("h2",{children:["Snip Is Your Everyday \xa0",(0,h.jsx)("em",{children:"Productivity"}),"\xa0 Companion."]})]}),(0,h.jsxs)(O,{children:[(0,h.jsx)(D,{children:(0,h.jsx)("img",{src:t(5090).A})}),(0,h.jsx)(E,{children:(0,h.jsx)("img",{src:t(1238).A})})]})]}),(0,h.jsx)(z,{})]})}const R=(0,s.Ay)(x)`
  display: none;
...
`,P=(0,s.Ay)(J)`
  top: -5em;
  box-shadow: 0 20px 18px rgba(var(--box-shadow-base-color), 1);
  transform: translateY(-2em) rotateZ(0.9deg);
`,q=(0,s.Ay)(J)`
  bottom: -5em;
...
`;function $(){return(0,h.jsxs)(R,{children:[(0,h.jsx)(P,{}),(0,h.jsx)(q,{}),(0,h.jsxs)(p,{children:[(0,h.jsxs)(G,{children:[(0,h.jsx)("h1",{children:"Dashboards"}),(0,h.jsx)("p",{children:"Pin notes to the navigation bar and use snippet references to create dashboards."})]}),(0,h.jsx)(K,{children:(0,h.jsx)("img",{src:t(1762).A})})]})]})}const _=(0,s.Ay)(x)`
  min-height: 40em;
...
`,ce=s.AH`
  margin: 1em;
`;const de=s.Ay.div`
  ${e=>function(e){switch(e){case"on-the-right":return se;case"on-the-left":return ne;case"at-the-bottom":return oe;case"centered":return ce}}(e.$position)}
  filter: drop-shadow(0px 5px 6px rgba(var(--box-shadow-base-color), 0.75));
`;function le(e){return(0,h.jsx)(re,{$width:e.width,className:e.className,children:(0,h.jsx)(de,{$position:e.position,children:e.children})})}const he=(0,s.Ay)(x)`
  padding-top: 7em;
  padding-bottom: 10em;
  min-height: 100vh;
...
`,be=(0,s.Ay)(ue)`
  ...
  transform: translateX(-5em) translateY(6.5em) rotateZ(2deg);
  height: 12em;
`;function je(){return(0,h.jsxs)(he,{children:[(0,h.jsx)(Ae,{}),(0,h.jsx)(fe,{}),(0,h.jsx)(be,{}),(0,h.jsx)("h1",{children:"Find And Organize"}),(0,h.jsxs)(me,{children:[(0,h.jsxs)(pe,{children:[(0,h.jsx)("h2",{children:(0,h.jsx)(f,{children:(0,h.jsx)(ae,{})})}),(0,h.jsx)("h2",{children:"Search"}),(0,h.jsx)("p",{children:"Snip comes with fast, effective search functionality. Search results are formatted nicely and give you a good preview of the content."})]}),(0,h.jsx)(ge,{position:"at-the-bottom",children:(0,h.jsx)(w,{children:(0,h.jsx)("img",{src:t(3696).A})})})]}),(0,h.jsx)(we,{}),(0,h.jsxs)(xe,{children:[(0,h.jsxs)(pe,{children:[(0,h.jsx)("h2",{children:(0,h.jsx)(f,{children:(0,h.jsx)(ie,{})})}),(0,h.jsx)("h2",{children:"Icons"}),(0,h.jsx)("p",{children:"Snip comes with a set of icons that can be used to give more meaning to your notes structure. They're simply nice to look at."})]}),(0,h.jsx)(ge,{position:"on-the-right",children:(0,h.jsx)(w,{children:(0,h.jsx)("img",{src:t(1315).A})})})]})]})}const ve=(0,s.Ay)(x)`
...
`,ze=s.Ay.div`
  ...
  max-width: calc(100% - 2em);
`;function Me(){return(0,h.jsxs)(ve,{children:[(0,h.jsxs)(p,{$flexDirection:"column",children:[(0,h.jsx)("h2",{children:"Spaced Repetition With Flashcards"}),(0,h.jsxs)(ye,{children:[(0,h.jsx)("p",{children:'Snip is all about taking notes. In Snip, a "Note" is in fact called a "Snippet" (hence the name "Snip"). A Snippet is a piece of data that can be represented in a graphical user interface.'}),(0,h.jsx)("p",{children:"When taking notes, you will be using the Rich Text Snippet. It represents some text on which you can apply formatting such as titles, sub-titles, quotes, code blocks, bold and italic text, etc."}),(0,h.jsx)("p",{children:"In the following section, you will learn about another Snippet type, the Flashcard Snippet, which is very similar to a Rich Text Snippet, but comes with additional functionality, allowing you to use Snip as a spaced repetition app."})]})]}),(0,h.jsxs)(p,{$flexDirection:"column",children:[(0,h.jsxs)(Be,{children:[(0,h.jsxs)(ze,{children:[(0,h.jsx)("h3",{children:"Flashcard Snippet"}),(0,h.jsx)("p",{children:"Conceptually, a flashcard snippet is identical to a real world flash card: It has two sides, where one side is a question or prompt and the other side is an answer or information. For example, this can be used for learning a new language."})]}),(0,h.jsx)(le,{width:"30em",position:"at-the-bottom",children:(0,h.jsx)(w,{children:(0,h.jsx)("img",{src:t(2687).A})})})]}),(0,h.jsxs)(Be,{children:[(0,h.jsxs)(ze,{children:[(0,h.jsx)("h3",{children:"Dashboard"}),(0,h.jsx)("p",{children:"The Dashboard gives an overview of all the flashcards in this folder. It shows learning progress over time and lists all flashcards ordered by relevance. The relevance of a card is calculated through a scoring algorithm."})]}),(0,h.jsx)(le,{width:"35em",position:"on-the-right",children:(0,h.jsx)(w,{children:(0,h.jsx)("img",{src:t(8098).A})})})]}),(0,h.jsxs)(Be,{children:[(0,h.jsxs)(ze,{children:[(0,h.jsx)("h3",{children:"Session Wizard"}),(0,h.jsx)("p",{children:"Flashcards can be practiced in an interactive mode. When stepping through the flashcards, a rating can be provided, which will re-prioritize the flashcards in the next session."})]}),(0,h.jsx)(le,{width:"25em",position:"at-the-bottom",children:(0,h.jsx)(w,{children:(0,h.jsx)("img",{src:t(2865).A})})})]})]})]})}const Se=(0,s.Ay)(x)`
  display: none;
  background-color: var(--accent-color-1);
  color: var(--accent-contrast-color-1);
  min-height: 100vh;
