"use strict";(self.webpackChunklandingpage_new=self.webpackChunklandingpage_new||[]).push([[583],{2573:(e,C,t)=>{t.d(C,{O:()=>n,hh:()=>o,wn:()=>a,xW:()=>s});var i=t(3540);const a=i.Ay.section`
  position: relative;
  overflow: hidden;
...
`},667:(e,C,t)=>{t.r(C),t.d(C,{default:()=>Me});var i=t(781),a=t(6540);function n(e,C){return 0===C?0:(e%C+C)%C}var r=t(3540);const s=r.Ay.div`
  display: inline-flex;
  position: relative;
  width: 7em;
`,o=(r.Ay.div`
...
`;var h=t(4848);function m(e){const[C,t]=(0,a.useReducer)((C=>n(C+1,e.words.length)),-1),[i,r]=[e.words.at(C),e.words.at(n(C+1,e.words.length))];(0,a.useEffect)((()=>{const e=setInterval((()=>{t()}),3e3);return()=>{clearInterval(e)}}),[]);const o=(0,h.jsxs)(a.Fragment,{children:[(0,h.jsx)("div",{children:"\xa0"}),e.children]});return-1===C?(0,h.jsxs)(s,{children:[o,(0,h.jsx)(d,{children:e.words.at(0)})]}):(0,h.jsxs)(s,{children:[o,(0,h.jsx)(l,{$animation:"out",children:i},i),(0,h.jsx)(l,{$animation:"in",children:r},r)]})}const x=r.Ay.a`
...
`;function v(){return(0,h.jsxs)(A,{children:[(0,h.jsxs)(b,{$flexDirection:"column",children:[(0,h.jsx)("p",{children:" Available on macOS. Coming soon on all other platforms."}),(0,h.jsx)(g,{href:"https://github.com/snip-app/client/releases/latest/download/Snip.dmg",children:(0,h.jsx)(w,{})})]}),(0,h.jsxs)(j,{$flexDirection:"column",children:[(0,h.jsx)("p",{children:" Available on iOS. Coming soon on all other platforms."}),(0,h.jsx)(g,{href:"https://apps.apple.com/ch/app/snip-notes-todos-reminders/id1584692945",children:(0,h.jsx)(w,{})})]})]})}const y=r.Ay.div`
...
`,F=r.Ay.div`
  ...
  background-color: black;
  transform: translateX(100%);
`;function Y(e){return(0,h.jsx)(y,{className:e.className,children:(0,h.jsxs)(W,{children:[(0,h.jsxs)(B,{children:[e.children,(0,h.jsx)(S,{}),(0,h.jsx)(k,{})]}),(0,h.jsx)(z,{}),(0,h.jsx)(M,{}),(0,h.jsx)(Z,{}),(0,h.jsx)(F,{})]})})}const Q=(0,r.Ay)(f.wn)`
...
`,I=r.Ay.div`
  ...
  padding-top: 1.25em;
  padding-bottom: 3em;
`,X=(0,r.Ay)(f.xW).attrs({$boxShadow:!0})`
  width: 90%;
  max-width: 1050px;
...
`,H=["Lightweight","Free Of Charge","Simple","Offline-First","Powerful","Modular","Private","Cross-Platform","Responsive"];function D(){return(0,h.jsxs)(a.Fragment,{children:[(0,h.jsxs)(Q,{children:[(0,h.jsxs)(O,{children:[(0,h.jsxs)("h1",{children:["Note Taking Can Be \xa0",(0,h.jsx)("em",{children:(0,h.jsx)(m,{words:H,children:(0,h.jsxs)(a.Fragment,{children:[(0,h.jsx)(L,{variation:1}),(0,h.jsx)(V,{})]})})})]}),(0,h.jsxs)("h2",{children:["Snip Is Your Everyday \xa0",(0,h.jsx)("em",{children:"Productivity"}),"\xa0 Companion."]})]}),(0,h.jsxs)(I,{children:[(0,h.jsx)(X,{children:(0,h.jsx)("img",{src:t(5090).A})}),(0,h.jsx)(N,{children:(0,h.jsx)("img",{src:t(1238).A})})]})]}),(0,h.jsx)(v,{})]})}const E=(0,r.Ay)(f.wn)`
  display: none;
...
`;function K(){return(0,h.jsxs)(E,{children:[(0,h.jsx)(T,{}),(0,h.jsx)(R,{}),(0,h.jsx)(J,{}),(0,h.jsxs)(f.O,{children:[(0,h.jsxs)(q,{children:[(0,h.jsx)("h1",{children:"Dashboards"}),(0,h.jsx)("p",{children:"Pin notes to the navigation bar and use references to create dashboards."})]}),(0,h.jsx)(P,{children:(0,h.jsx)("img",{src:t(1762).A})})]})]})}const G=(0,r.Ay)(f.wn)`
  min-height: 40em;
...
`,se=r.AH`
  margin: 1em;
`;const oe=r.Ay.div`
  ${e=>function(e){switch(e){case"on-the-right":return ae;case"on-the-left":return ne;case"at-the-bottom":return re;case"centered":return se}}(e.$position)}
  filter: drop-shadow(0px 5px 6px rgba(var(--box-shadow-base-color), 0.75));
`;function ce(e){return(0,h.jsx)(ie,{$width:e.width,className:e.className,children:(0,h.jsx)(oe,{$position:e.position,children:e.children})})}const de=(0,r.Ay)(f.wn)`
  padding-top: 7em;
  padding-bottom: 10em;
  min-height: 100vh;
...
`,Ae=(0,r.Ay)(we)`
  ...
  transform: translateX(-5em) translateY(6.5em) rotateZ(2deg);
  height: 12em;
`;function ue(){return(0,h.jsxs)(de,{children:[(0,h.jsx)(fe,{}),(0,h.jsx)(ge,{}),(0,h.jsx)(Ae,{}),(0,h.jsx)("h1",{children:"Find And Organize"}),(0,h.jsxs)(le,{children:[(0,h.jsxs)(me,{children:[(0,h.jsx)("h2",{children:(0,h.jsx)(f.hh,{children:(0,h.jsx)(te,{})})}),(0,h.jsx)("h2",{children:"Search"}),(0,h.jsx)("p",{children:"Snip offers fast and efficient search functionality, delivering well-formatted results that provide clear and concise previews of the content."})]}),(0,h.jsx)(xe,{position:"at-the-bottom",children:(0,h.jsx)(f.xW,{children:(0,h.jsx)("img",{src:t(3696).A})})})]}),(0,h.jsx)(pe,{}),(0,h.jsxs)(he,{children:[(0,h.jsxs)(me,{children:[(0,h.jsx)("h2",{children:(0,h.jsx)(f.hh,{children:(0,h.jsx)(Ce,{})})}),(0,h.jsx)("h2",{children:"Icons"}),(0,h.jsx)("p",{children:"Snip includes a collection of icons that enhance the structure of your notes, adding both clarity and visual appeal."})]}),(0,h.jsx)(xe,{position:"on-the-right",children:(0,h.jsx)(f.xW,{children:(0,h.jsx)("img",{src:t(1315).A})})})]})]})}const be=(0,r.Ay)(f.wn)`
...
`,ye=r.Ay.div`
  ...
  max-width: calc(100% - 2em);
`;function We(){return(0,h.jsxs)(be,{children:[(0,h.jsxs)(f.O,{$flexDirection:"column",children:[(0,h.jsx)("h2",{children:"Spaced Repetition With Flashcards"}),(0,h.jsxs)(je,{children:[(0,h.jsx)("p",{children:'Snip is all about taking notes. In Snip, a "Note" is in fact called a "Snippet" (hence the name "Snip"). A Snippet is a piece of data that can be represented in a graphical user interface.'}),(0,h.jsx)("p",{children:"When taking notes, you will be using the Rich Text Snippet. It represents some text on which you can apply formatting such as titles, sub-titles, quotes, code blocks, bold and italic text, etc."}),(0,h.jsx)("p",{children:"In the following section, you will learn about another Snippet type, the Flashcard Snippet, which is very similar to a Rich Text Snippet, but comes with additional functionality, allowing you to use Snip as a spaced repetition app."})]})]}),(0,h.jsxs)(f.O,{$flexDirection:"column",children:[(0,h.jsxs)(ve,{children:[(0,h.jsxs)(ye,{children:[(0,h.jsx)("h3",{children:"Flashcard Snippet"}),(0,h.jsx)("p",{children:"Conceptually, a flashcard snippet is identical to a real world flash card: It has two sides, where one side is a question or prompt and the other side is an answer or information. For example, this can be used for learning a new language."})]}),(0,h.jsx)(ce,{width:"30em",position:"at-the-bottom",children:(0,h.jsx)(f.xW,{children:(0,h.jsx)("img",{src:t(2687).A})})})]}),(0,h.jsxs)(ve,{children:[(0,h.jsxs)(ye,{children:[(0,h.jsx)("h3",{children:"Dashboard"}),(0,h.jsx)("p",{children:"The Dashboard gives an overview of all the flashcards in this folder. It shows your learning progress over time and lists all flashcards ordered by relevance. The relevance of a card is calculated through a scoring algorithm."})]}),(0,h.jsx)(ce,{width:"35em",position:"on-the-right",children:(0,h.jsx)(f.xW,{children:(0,h.jsx)("img",{src:t(8098).A})})})]}),(0,h.jsxs)(ve,{children:[(0,h.jsxs)(ye,{children:[(0,h.jsx)("h3",{children:"Session Wizard"}),(0,h.jsx)("p",{children:"Flashcards can be practiced in an interactive mode. When stepping through the flashcards, a rating can be provided, which will re-prioritize the flashcards in the next session."})]}),(0,h.jsx)(ce,{width:"25em",position:"at-the-bottom",children:(0,h.jsx)(f.xW,{children:(0,h.jsx)("img",{src:t(2865).A})})})]})]})]})}const Be=(0,r.Ay)(f.wn)`
  display: none;
  background-color: var(--accent-color-1);
  color: var(--accent-contrast-color-1);
  min-height: 100vh;
